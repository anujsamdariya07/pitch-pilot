  ...
  const steps = [
    {
      ...
      description:
        'Please fill out the standard information needed for your webinar',
  ...
  return (
    <Dialog open={isModalOpen} onOpenChange={setModalOpen}>
      <DialogTrigger asChild>
        <button
          className='rounded-xl flex gap-2 items-center hover:cursor-pointer px-4 py-2 border border-border bg-primary/10 backdrop-blue-sm text-sm font-normal text-primary hover:bg-primary-20'
