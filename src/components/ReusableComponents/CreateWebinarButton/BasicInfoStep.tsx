...
const BasicInfoStep = (props: Props) => {
  ...
  const handleDataChange = (newDate: Date | undefined) => {
    updateBasicInfoField('date', newDate);
    if (newDate) {
      const today = new Date();
      today.setHours(0, 0, 0, 0);
      if (newDate < today) {
        console.error('ERROR: Cannot select a date in the past!');
    ...
    <div className='space-y-6'>
      ...
      <div className='space-y-2'>
        ...
        <Textarea
          ...
          value={description || ''}
          onChange={handleChange}
          placeholder='Tell the customers what your webinar is about'
          className={cn(
